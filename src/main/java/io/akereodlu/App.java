...
public class App {
    public static void main(String[] args) {
        //Accounts accounts1 = new Accounts(1,"Black Jack Johnson",AccountType.CHECKING,Status.OPEN,100.0,OverDraft.ENABBLED);
       // accounts1.addTransactions(AccountType.CHECKING,10.0,"debit");
